...
class PaymentManager:
    ...
    OWNER_TELEGRAM = "@your_telegram_username"  # ← SIZIŇ TELEGRAM ADYŇYZ
    ...
    def get_plan_for_members(self, member_count: int) -> str | None:
        """Agza sanyna görä dogry plany tap."""
    ...
    def activate_paid_plan(self, chat_id: int, plan: str, months: int = 1) -> bool:
        ...
        logger.info(f"Activated {plan} plan for chat {chat_id} until {new_expiry}")
        return True